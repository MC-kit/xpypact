...
def compute_709_bins() -> NDArrayFloat:
    """Compute bins for 709 groups according to the specification.
...
def are_fluxes_equal(a: Fluxes, b: Fluxes) -> bool:
    ...
    ----------
    a
        the first flux to compare
    b
        the second flux to compare
...
def read_fluxes(
    ...
    stream
        IO to load from
    define_bins_and_fluxes
        strategy to extract bins and values
...
def define_arb_bins_and_fluxes(data: NDArrayFloat) -> tuple[NDArrayFloat, NDArrayFloat]:
    ...
    ----------
    data
        the array containing both bins and values
...
def define_709_bins_and_fluxes(data: NDArrayFloat) -> tuple[NDArrayFloat, NDArrayFloat]:
    ...
    ----------
    data
        the array containing values only
