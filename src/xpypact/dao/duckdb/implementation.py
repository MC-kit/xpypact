...
class DuckDBDAO(ms.Struct):
    """Implementation of DataAccessInterface (to be defined) for DuckDB."""
...
def save(
    ...
    ----------
    cursor
        separate multi-threaded cursor to access DuckDB, use con.cursor() in caller
    collector_result
        collected inventories as Polars frames
    """
